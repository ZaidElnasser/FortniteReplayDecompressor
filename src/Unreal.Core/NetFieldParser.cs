    ...
    public class NetFieldParser
    {
        ...
        public NetFieldParser(NetGuidCache cache, ParseMode mode, string assemblyNameFilter = "ReplayReader")
        {
            ...
            var types = AppDomain.CurrentDomain.GetAssemblies()
                .Where(a => a.FullName != null && (a.FullName.Contains(assemblyNameFilter) || a.FullName.Contains("Unreal.Core")))
        ...
        /// </summary>
        /// <returns>true if field was read, false otherwise</returns>
        ...
        /// </summary>
        public INetFieldExportGroup? CreateType(int groupId)
        {
            if (!NetFieldGroups.TryGetValue(groupId, out var exportGroup))
            {
                return null;
            }
        ...
        /// Create the object associated with the NetFieldExportGroup. 
        /// </summary>
        public INetFieldExportGroup? CreateType(string groupName)
        {
            if (!NetFieldGroups.TryGetValue(groupName, out var exportGroup))
            {
                return null;
            }
